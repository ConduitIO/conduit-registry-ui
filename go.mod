module github.com/ConduitIO/conduit-registry-ui

go 1.25.8

// conduit is pinned to the same nightly the index-CI tooling in
// ConduitIO/conduit-connector-registry pins (b55f9c4 = v0.20.0-nightly
// 2026-07-30). This is the first version whose cmd/conduit/root/connectors
// exports DefaultTrustAnchors()/AnchorLoadErr() with the production PEMs
// go:embed'd — the verifier + anchors this CLI imports rather than
// reimplements. See cmd/registry-verify/main.go.
...
require (
	...
	github.com/conduitio/conduit-connector-protocol v0.9.5 // indirect
	github.com/conduitio/conduit-connector-s3 v0.9.3 // indirect
	github.com/conduitio/conduit-connector-sdk v0.14.2 // indirect
	github.com/conduitio/conduit-processor-sdk v0.5.2-0.20260727035706-8376e49ad512 // indirect
	github.com/conduitio/conduit-schema-registry v0.2.6 // indirect
	github.com/conduitio/ecdysis v0.6.0 // indirect
	...
	github.com/piotrkowalczuk/promgrpc/v4 v4.3.0 // indirect
